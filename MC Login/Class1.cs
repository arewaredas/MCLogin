...
namespace MC_Login
{
    class Class1
    {
        ...
        public static extern void Initialize(string applicationId, ref Class1.EventHandlers handlers, bool autoRegister, string optionalSteamId);
        ...
        public static extern void UpdatePresence(ref Class1.RichPresence presence);
        ...
        public struct EventHandlers
        {
            ...
            public Class1.ReadyCallback readyCallback;


            public Class1.DisconnectedCallback disconnectedCallback;


            public Class1.ErrorCallback errorCallback;
        }
